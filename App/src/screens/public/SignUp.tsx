...
function SignUp() {
	...
	return (
		<KeyboardAwareScrollView  contentContainerStyle={{flexGrow: 1, paddingHorizontal: 20,  paddingTop: insets.top, justifyContent: 'center', backgroundColor: '#FFFFFF'}} enableOnAndroid keyboardShouldPersistTaps="handled" showsVerticalScrollIndicator={false}>
